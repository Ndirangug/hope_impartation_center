<?php
    ...
    define( 'K_CACHE_PURGE_INTERVAL', 1 );
    ...
    define( 'K_UPLOAD_DIR', 'couch/uploads' );
    ...
    define( 'K_EMAIL_TO', 'info@hopeimpartationcenter.or.ke' );

    // 14.
    // Will be used as the sender of messages delivered by contact forms to the address above.
    define( 'K_EMAIL_FROM', 'contact-form@hopeimpartationcenter.or.ke' );
